...
ChildBrowser.prototype.goBack = function(){
	cordova.exec(null, null, "ChildBrowser", "goBack", []);
};

ChildBrowser.prototype.goDoubleBack = function(){
	cordova.exec(null, null, "ChildBrowser", "goDoubleBack", []);
};
